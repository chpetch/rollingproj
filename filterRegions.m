function [BW_out,properties] = filterRegions(BW_in,thresh)
...
% Auto-generated by imageRegionAnalyzer app on 24-Jul-2015
%---------------------------------------------------------

BW_out = BW_in;

% Filter image based on image properties.
BW_out = bwpropfilt(BW_out, 'Area', [thresh + eps(thresh), Inf]);

% Get properties.
properties = regionprops(BW_out, {'Area', 'Eccentricity', 'EquivDiameter', 'EulerNumber', 'MajorAxisLength', 'MinorAxisLength', 'Orientation', 'Perimeter', 'Centroid'});
